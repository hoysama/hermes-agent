...
- Use the matching environment names for active providers: `HCNSEC_API_KEY`, `IAMHC_API_KEY`, `LYCLAUDE_API_KEY`, `VYCEAI_API_KEY`, `NARAROUTER_API_KEY`, `MODERNROUTER_API_KEY`, and `ZENMUX_API_KEY`.
