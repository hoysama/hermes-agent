...
Provider: nararouter (mistral-medium-3-5 analysis + agnes-2.5-flash decisions)
"""
import json
import requests
import sys
...
# NaraRouter only. Mistral Medium analyzes first; Agnes produces pair decisions.
...
ANALYSIS_MODEL = 'mistral-medium-3-5'
